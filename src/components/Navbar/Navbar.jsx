        ...
        <div className="collapse navbar-collapse" id="collapsibleNavId">
          <ul className="navbar-nav me-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item ms-3">
              <Link title='wishlist' className="nav-link position-relative" to="wishlist">
              <i class="fa-solid fa-heart"></i>
                <span className='badge p-1 bg-main text-white position-absolute top-0 end-0'>{countWishlist}</span>
              </Link>
            </li>
